import { hasInjectionContext, inject, version, unref, getCurrentInstance, ref, computed, useSSRContext, defineComponent, h, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, mergeProps, createApp, effectScope, reactive, getCurrentScope, isRef as isRef$1, isReactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, onScopeDispose, defineAsyncComponent, shallowRef, isReadonly, toRefs, markRaw, withCtx, openBlock, createBlock, isShallow } from 'vue';
...
import { h as createError$1, l as sanitizeStatusCode, m as createHooks, n as getRequestHeader, o as setCookie, p as getCookie, q as deleteCookie, t as toRouteMatcher, r as createRouter$1 } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-MXC_EgtA.mjs');
...
const unhead_GImWyN5Cf5 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./about-HMQ8z5YM.mjs')
  },
  {
    name: "auth-callback",
    path: "/auth/callback",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./callback-D0SlXXjO.mjs')
  },
  {
    name: "changelog",
    path: "/changelog",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./changelog-C191RMNI.mjs')
  },
  {
    name: "details-id",
    path: "/details/:id()",
    component: () => import('./_id_-Czq1ApRg.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-4MU66TxS.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./privacy-BtSi_8ra.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./terms-D-Hi73p9.mjs')
  },
  {
    name: "user",
    path: "/user",
    meta: __nuxt_page_meta || {},
    component: () => import('./user-CPEuj_SC.mjs')
  }
];
...
const revive_payload_server_bgxcJZuwCG = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_FJmb5a7dba = /* @__PURE__ */ defineNuxtPlugin(({ $pinia }) => {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-ef86e14b><use${ssrRenderAttr("xlink:href", iconName.value)} data-v-ef86e14b></use></svg>`);
    };
  }
});
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Icon/Svg.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ef86e14b"]]);
const svgicon_WxC0AOUlIy = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.component("svg-icon", __nuxt_component_7);
});
const plugins = [
  unhead_GImWyN5Cf5,
  plugin$1,
  revive_payload_server_bgxcJZuwCG,
  plugin,
...
const layouts = {
  default: () => import('./default-D5dBvG-o.mjs'),
  empty: () => import('./empty-CB2gAi1s.mjs'),
  privacy: () => import('./privacy-CUEQTWKY.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DD9ILl0u.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DAbPjxo4.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_sass-embedded@1.79.5_vite@5.4.8/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_sass-embedded@1.79.5_vite@5.4.8/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { camelize_1 as A, throwError as B, isBoolean as C, useGetDerivedNamespace as D, useIdInjection as E, isNumber as F, useId as G, useZIndex as H, defaultNamespace as I, isStringNumber as J, isUndefined as K, asyncDataDefaults as L, createError as M, NOOP_1 as N, On as O, hash as P, fetchDefaults as Q, useRequestFetch as R, namespaceContextKey as S, zIndexContextKey as T, isElement as U, storages as V, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, useRoute as e, __nuxt_component_7 as f, useNamespace as g, hasProtocol as h, isObject_1 as i, joinURL as j, hyphenate_1 as k, isString_1 as l, defineStore as m, nuxtLinkDefaults as n, injectHead as o, parseQuery as p, resolveUnrefHeadInput as q, resolveRouteObject as r, defineNuxtRouteMiddleware as s, br as t, useRouter as u, isFunction_1 as v, withTrailingSlash as w, isArray_1 as x, debugWarn as y, hasOwn_1 as z };

import { u as useConfigStore, _ as _sfc_main$2 } from './config-BdCrk5j_.mjs';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Home/Terms.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HomeTerms = _sfc_main$1;
      _push(ssrRenderComponent(_component_HomeTerms, _attrs, null, _parent));
    };
  }
});
...
//# sourceMappingURL=terms-D7Dltcoo.mjs.map

import { ref, watch, computed, getCurrentInstance, unref, defineComponent, openBlock, createElementBlock, mergeProps, renderSlot, inject, createBlock, resolveDynamicComponent, withCtx, Fragment, normalizeClass, createCommentVNode, provide, reactive, toRef, markRaw, effectScope, shallowRef, nextTick, createVNode, Transition, createElementVNode, normalizeStyle, withModifiers, renderList, withDirectives, vShow, useAttrs as useAttrs$1, toDisplayString, getCurrentScope, onScopeDispose, useSlots, Text as Text$1, readonly, Teleport as Teleport$1 } from 'vue';
import { F as isNumber, J as isStringNumber, l as isString_1, g as useNamespace, K as isUndefined, H as useZIndex, m as defineStore } from './server.mjs';
import { b as buildProps, g as definePropType, w as withInstall, y as useGlobalSize, j as useSizeProp, k as iconPropType, z as loading_default, i as withNoopInstall, m as mutable, A as full_screen_default, B as scale_to_original_default, o as useLocale, d as close_default, D as arrow_left_default, F as arrow_right_default, G as zoom_out_default, H as zoom_in_default, I as refresh_left_default, J as refresh_right_default, a as componentSizes, q as useGlobalConfig, K as keysOf, e as useHttp } from './useHttp-B4N22ap-.mjs';
...
var Teleport = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__file", "teleport.vue"]]);
...
var ImageViewer = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "image-viewer.vue"]]);
...
var Image$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "image.vue"]]);
...
const productCateListAPi = (data) => useHttp.get("/v1/avenue/productCategory/index", {
  params: data
});
const productListAPi = (data) => useHttp.get("/v1/avenue/product/index", data);
const productAddClickAPi = (id, data) => useHttp.put("/v1/avenue/product/addClick/" + id, data);
const productSubmitApi = (data) => useHttp.post("/v1/avenue/product/submit", data);
const useProductStore = defineStore("product", {
  ...
  //方法
  actions: {
    async getProductCateList(params) {
      try {
        const result = await productCateListAPi(params);
        if (result.code == 200) {
    ...
    async addClick(id) {
      const result = await productAddClickAPi(id, {});
      if (result.code == 200) {
        return true;
      }
    },
    async submitProduct(params) {
      const result = await productSubmitApi(params);
      if (result.code == 200) {
        return true;
      }
    }
...
export { ElIcon as E, _export_sfc as _, useEventListener as a, useProductStore as b, useThrottleFn as c, ElImage as d, ElText as e, ElButton as f, formContextKey as g, formItemContextKey as h, useResizeObserver as i, addUnit as j, useAttrs as k, useFormItem as l, useFormItemInputId as m, useFormDisabled as n, ElTeleport as o, useDeprecated as p, onClickOutside as q, refDebounced as r, useTimeoutFn as s, tryOnScopeDispose as t, useFormSize as u, isClient as v };
//# sourceMappingURL=button-EgJ5iLgh.mjs.map
